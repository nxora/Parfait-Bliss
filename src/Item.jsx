...
function Item() {
  ...
  return (
    <div className='bg-[#FBCEC3]'>

    <div className=" p-10 justify-center mx-auto flex flex-col sm:flex-row md:gap-24    ">
      <div>
      ...
      <div>
        ...
        <button className="mt-6 px-10 py-3 bg-[#E9BEB4] text-[#A6374B] rounded-lg">Continue Shopping</button>
      </div>
    </div>
      <RelatedProduct/>
    </div>
